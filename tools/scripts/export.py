...
export_command = f"{godot_binary_file_name} --path \"{os.path.join(project_directory, "game")}\" --headless --rendering-driver vulkan --export-{export_command_type} \"{platform_arg} {configuration} {architecture} {precision}\" \"{os.path.join(project_directory, "bin", platform_arg, build_file_name_and_type)}\" --verbose"
